...
import { SocialConfiguration } from 'src/app/@models/social-configuration';
...
@Component({
  selector: 'app-social-configuration',
  templateUrl: './social-configuration.component.html',
  styleUrls: ['./social-configuration.component.css']
})

export class SocialConfigurationComponent implements OnInit {

  constructor(private dataSourceBuilder: NbTreeGridDataSourceBuilder<SocialConfiguration>) {
    this.dataSource = this.dataSourceBuilder.create(this.data);
  }
  allColumns = ['name', 'size', 'kind', 'items'];
  dataSource: NbTreeGridDataSource<SocialConfiguration>;
